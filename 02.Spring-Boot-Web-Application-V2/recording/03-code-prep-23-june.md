<!---
Current Directory : /Ranga/001.Notes/00.CoursePreparations/2022-06-Spring-Boot-Upgrade-Code/code-end-23-june
-->
...
public class Todo {
	...
	@FutureOrPresent(message = "Enter a date in future")
...
public class TodoController {
	...
	public String showNewTodoPage(ModelMap model) {
		...
		model.addAttribute("todo", new Todo(0,username,"",LocalDate.now(),false));
		return "todo";
	}
